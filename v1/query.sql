CREATE DATABASE backend-sec70-dasencio;
CREATE USER 'backend-sec70-dasencio'@'localhost' IDENTIFIED BY 'l4cl4v3-c11s4';
GRANT ALL PRIVILEGES ON backend-sec70-dasencio . * TO 'backend-sec70-dasencio'@'localhost';
FLUSH PRIVILEGES;

USE backend-sec70-dasencio;
