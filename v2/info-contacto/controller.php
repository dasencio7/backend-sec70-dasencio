...
class Controlador
{
    ...
    public function getAll()
    {
        ...
        $sql = "SELECT id, nombre, icono, texto, texto_adicional, activo FROM `info-contacto`;";
    ...
    public function postNuevo($_newObject)
    {
        ...
        $sql = "INSERT INTO `info-contacto` (id, nombre, icono, texto, texto_adicional, activo) VALUES (?, ?, ?, ?, ?, true);";
        $stmt = mysqli_prepare($connection, $sql);
        mysqli_stmt_bind_param($stmt, 'issss', $id, $_newObject->nombre, $_newObject->icono, $_newObject->texto, $_newObject->texto_adicional);
